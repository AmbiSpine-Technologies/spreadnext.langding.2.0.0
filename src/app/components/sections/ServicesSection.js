...
// import { fadeIn, scaleIn } from "@/animations/animation"; // Make sure to export scaleIn from your lib
// import { Calculator, Briefcase, BarChart3, ShieldCheck, Zap } from "lucide-react";
...
//                 <motion.div 
//                   key={idx}
//                   variants={scaleIn("none", idx * 0.1)} // Card zoom-in effect
//                   initial="hidden"
//                   whileInView="show"
//                   viewport={{ once: true }}
//                   className="bg-white p-6 rounded-2xl shadow-sm border border-white/50 flex items-start gap-4 hover:shadow-xl transition-all duration-300 group cursor-default"
//                 >
//                   <div className={`p-4 rounded-2xl ${service.bgColor} flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
//                     {service.icon}
//                   </div>
//                   <div>
//                     <h3 className="font-bold text-[#1B1B24] text-lg mb-1">{service.title}</h3>
//                     <p className="text-gray-500 text-sm leading-relaxed">{service.description}</p>
//                   </div>
//                 </motion.div>
//               ))}
              
//               {/* Bottom Special Card - Spans across or centered */}
//               <motion.div 
...
//               >
//                 <div className="p-4 rounded-2xl bg-purple-50 flex-shrink-0">
...
//           <Button className="bg-[#0013E3] hover:bg-blue-800 text-white rounded-full px-12 h-14 text-lg font-bold shadow-lg shadow-blue-200">
//             Explore Business Services
//           </Button>
//           <Button className="bg-[#D1D9E6]/50 hover:bg-[#D1D9E6] text-[#1B1B24] rounded-full px-12 h-14 text-lg font-bold transition-all">
//             Talk to expert
//           </Button>
//         </div>
//       </div>
  ...
  return (
    <section className="py-24 px-6 bg-[#EEF2FF] overflow-hidden">
      <div className="max-w-[1400px] mx-auto">
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mt-20">
          <Button className="bg-[#0013E3]  text-white rounded-full px-12 h-14 text-lg font-bold">
            Explore Business Services
          </Button>
          <Button className="bg-[#868b9380] hover:bg-[#B5C1D380] !text-[#000000] rounded-full px-12 h-14 text-lg font-bold">
            Talk to expert
          </Button>
        </div>
      </div>
