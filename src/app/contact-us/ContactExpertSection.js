...
// import { Check, MoveRight, X, Headphones, Globe } from "lucide-react";

// const SERVICES = [
//   "Taxation — Income Tax / ITR Filing",
...
//     if (!isOtherSelected) delete requiredFields.otherServiceDetails;
...
//     try {
//       // 2. Correct Fetch Implementation
...
//     } finally {
//       setIsSubmitting(false); // Stop loading regardless of result
//     }
//   };
...
//                     <label className="text-[11px] font-bold uppercase text-[#475569]">Full Name</label>
//                     <input name="name" onChange={handleChange} className="w-full p-3 border border-[#E2E8F0] rounded-lg text-sm outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-blue-50/50 transition-all" placeholder="Rajesh Kumar" />
//                   </div>
//                   <div className="space-y-1.5">
//                     <label className="text-[11px] font-bold uppercase text-[#475569]">Phone</label>
//                     <input name="phone" onChange={handleChange} className="w-full p-3 border border-[#E2E8F0] rounded-lg text-sm outline-none focus:border-[#2563EB]" placeholder="+91 98765 43210" />
//                   </div>
//                 </div>
//                 <div className="space-y-1.5">
//                   <label className="text-[11px] font-bold uppercase text-[#475569]">Email Address</label>
//                   <input name="email" type="email" onChange={handleChange} className="w-full p-3 border border-[#E2E8F0] rounded-lg text-sm outline-none focus:border-[#2563EB]" placeholder="rajesh@company.com" />
//                 </div>
//                 <div className="space-y-1.5">
//                   <label className="text-[11px] font-bold uppercase text-[#475569]">Company Name</label>
//                   <input name="company" onChange={handleChange} className="w-full p-3 border border-[#E2E8F0] rounded-lg text-sm outline-none focus:border-[#2563EB]" placeholder="Acme Pvt. Ltd." />
//                 </div>
//                 <div className="space-y-1.5">
//                   <label className="text-[11px] font-bold uppercase text-[#475569]">Service Needed</label>
//                   <select name="service" onChange={handleChange} className="w-full p-3 border border-[#E2E8F0] rounded-lg text-sm outline-none focus:border-[#2563EB] appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2212%22%20height%3D%2212%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%2394A3B8%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')] bg-no-repeat bg-[right_1rem_center]">
...
//                     <label className="text-[11px] font-bold uppercase text-[#475569]">Please specify your requirement</label>
//                     <textarea
...
//                     </div>
//                     )}
//                 <button type="submit" className="w-full bg-[#2563EB] text-white p-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#1D4ED8] transition-all mt-4">
//                   Request free consultation <MoveRight className="w-4 h-4" />
//                 </button>
//               </form>
...
//               <p className="text-[#64748B] text-sm leading-relaxed">Our advisory team will reach out within 24 hours.<br />Check your email for a confirmation.</p>
//             </div>
//           )}
//         </div>
//       </div>
